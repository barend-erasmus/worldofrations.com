if (function(e, t) {
    ...
    function r(e, t, n) {
        ...
        if ("string" == typeof t) {
            if (Ee.test(t)) return fe.filter(t, e, n);
            t = fe.filter(t, e)
        }
    ...
    function c() {
        Z.removeEventListener("DOMContentLoaded", c), e.removeEventListener("load", c), fe.ready()
    }
    ...
    function h(e) {
        var t, n = e.ownerDocument,
            i = e.nodeName,
            r = qe[i];
        return r || (t = n.body.appendChild(n.createElement(i)), r = fe.css(t, "display"), t.parentNode.removeChild(t), "none" === r && (r = "block"), qe[i] = r, r)
    }

    function g(e, t) {
        for (var n, i, r = [], o = 0, s = e.length; o < s; o++) i = e[o], i.style && (n = i.style.display, t ? ("none" === n && (r[o] = Ne.get(i, "display") || null, r[o] || (i.style.display = "")), "" === i.style.display && je(i) && (r[o] = h(i))) : "none" !== n && (r[o] = "none", Ne.set(i, "display", n)));
    ...
    function y(e, t, n, i, r) {
        for (var o, s, a, l, u, c, d = t.createDocumentFragment(), f = [], p = 0, h = e.length; p < h; p++)
            ...
            for (s = s || d.appendChild(t.createElement("div")), a = (ze.exec(o) || ["", ""])[1].toLowerCase(), l = Ve[a] || Ve._default, s.innerHTML = l[1] + fe.htmlPrefilter(o) + l[2], c = l[0]; c--;) s = s.lastChild;
            fe.merge(f, s.childNodes), s = d.firstChild, s.textContent = ""
        } else f.push(t.createTextNode(o));
        for (d.textContent = "", p = 0; o = f[p++];)
            if (i && fe.inArray(o, i) > -1) r && r.push(o);
            else if (u = fe.contains(o.ownerDocument, o), s = m(d.appendChild(o), "script"), u && v(s), n)
    ...
    function S(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            Ie.hasData(e) && (a = Ie.access(e), l = fe.extend({}, a), Ie.set(t, l))
        }
    }
    ...
    function D(e, t, i, r) {
        ...
        var o, s, a, l, u, c, d = 0,
            ...
            h = t[0],
            g = fe.isFunction(h);
        if (g || f > 1 && "string" == typeof h && !ce.checkClone && Ze.test(h)) return e.each(function(n) {
            var o = e.eq(n);
            g && (t[0] = h.call(this, n, o.html())), D(o, t, i, r)
        });
        if (f && (o = y(t, e[0].ownerDocument, !1, e, r), s = o.firstChild, 1 === o.childNodes.length && (o = s), s || r)) {
            for (a = fe.map(m(o, "script"), C), l = a.length; d < f; d++) u = o, d !== p && (u = fe.clone(u, !0, !0), l && fe.merge(a, m(u, "script"))), i.call(e[d], u, d);
            if (l)
                for (c = a[a.length - 1].ownerDocument, fe.map(a, x), d = 0; d < l; d++) u = a[d], Ue.test(u.type || "") && !Ne.access(u, "globalEval") && fe.contains(c, u) && (u.src ? fe._evalUrl && fe._evalUrl(u.src) : n(u.textContent.replace(tt, ""), c))
        }
        return e
    }

    function O(e, t, n) {
        for (var i, r = t ? fe.filter(t, e) : e, o = 0; null != (i = r[o]); o++) n || 1 !== i.nodeType || fe.cleanData(m(i)), i.parentNode && (n && fe.contains(i.ownerDocument, i) && v(m(i, "script")), i.parentNode.removeChild(i));
        return e
    }

    function k(e, t, n) {
        var i, r, o, s, a = e.style;
        return n = n || rt(e), n && (s = n.getPropertyValue(t) || n[t], "" !== s || fe.contains(e.ownerDocument, e) || (s = fe.style(e, t)), !ce.pixelMarginRight() && it.test(s) && nt.test(t) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o)), void 0 !== s ? s + "" : s
    }
    ...
    function F(e, t, n, i, r) {
        for (var o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; o < 4; o += 2) "margin" === n && (s += fe.css(e, n + He[o], !0, r)), i ? ("content" === n && (s -= fe.css(e, "padding" + He[o], !0, r)), "margin" !== n && (s -= fe.css(e, "border" + He[o] + "Width", !0, r))) : (s += fe.css(e, "padding" + He[o], !0, r), "padding" !== n && (s += fe.css(e, "border" + He[o] + "Width", !0, r)));
        return s
    }
    ...
    function P(e, t, n) {
        ...
        if (e.getClientRects().length && (i = e.getBoundingClientRect()[t]), i <= 0 || null == i) {
            if (i = k(e, t, o), (i < 0 || null == i) && (i = e.style[t]), it.test(i)) return i;
    ...
    function R() {
        dt && (e.requestAnimationFrame(R), fe.fx.tick())
    }
    ...
    function q(e, t, n) {
        ...
        if ((l = !fe.isEmptyObject(t)) || !fe.isEmptyObject(p)) {
            d && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], u = v && v.display, null == u && (u = Ne.get(e, "display")), c = fe.css(e, "display"), "none" === c && (u ? c = u : (g([e], !0), u = e.style.display || u, c = fe.css(e, "display"), g([e]))), ("inline" === c || "inline-block" === c && null != u) && "none" === fe.css(e, "float") && (l || (f.done(function() {
                h.display = u
            }), null == u && (c = h.display, u = "none" === c ? "" : c)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", f.always(function() {
                h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
            })), l = !1;
            for (i in p) l || (v ? "hidden" in v && (m = v.hidden) : v = Ne.access(e, "fxshow", {
                display: u
            }), o && (v.hidden = !m), m && g([e], !0), f.done(function() {
                m || g([e]), Ne.remove(e, "fxshow");
                for (i in p) fe.style(e, i, p[i])
            })), l = W(m ? v[i] : 0, i, f), i in v || (v[i] = l.start, m && (l.end = l.start, l.start = 0))
        }
    }
    ...
    function z(e, t, n) {
        var i, r, o = 0,
            ...
            l = function() {
                if (r) return !1;
                for (var t = ct || H(), n = Math.max(0, u.startTime + u.duration - t), i = n / u.duration || 0, o = 1 - i, s = 0, l = u.tweens.length; s < l; s++) u.tweens[s].run(o);
        ...
        for (B(c, u.opts.specialEasing); o < s; o++)
            if (i = z.prefilters[o].call(u, e, c, u.opts)) return fe.isFunction(i.stop) && (fe._queueHooks(u.elem, u.opts.queue).stop = fe.proxy(i.stop, i)), i;
        return fe.map(c, W, u), fe.isFunction(u.opts.start) && u.opts.start.call(e, u), fe.fx.timer(fe.extend(l, {
            elem: e,
            anim: u,
            queue: u.opts.queue
    ...
    function V(e, t, n, i) {
        ...
        if (fe.isArray(t)) fe.each(t, function(t, r) {
            n || xt.test(e) ? i(e, r) : V(e + "[" + ("object" == typeof r && null != r ? t : "") + "]", r, n, i)
        });
    ...
    fe.fn = fe.prototype = {
        ...
        isPlainObject: function(e) {
            var t, n;
            return !(!e || "[object Object]" !== se.call(e) || (t = ee(e)) && ("function" != typeof(n = ae.call(t, "constructor") && t.constructor) || le.call(n) !== ue))
        },
    ...
    var ve = function(e) {
        function t(e, t, n, i) {
            var r, o, s, a, l, c, f, p = t && t.ownerDocument,
                h = t ? t.nodeType : 9;
            if (n = n || [], "string" != typeof e || !e || 1 !== h && 9 !== h && 11 !== h) return n;
            if (!i && ((t ? t.ownerDocument || t : j) !== L && k(t), t = t || L, I)) {
                if (11 !== h && (l = ge.exec(e)))
                    if (r = l[1]) {
                        if (9 === h) {
                ...
                if (w.qsa && !U[e + " "] && (!F || !F.test(e))) {
                    if (1 !== h) p = t, f = e;
                        ...
                        for ((a = t.getAttribute("id")) ? a = a.replace(be, we) : t.setAttribute("id", a = H), c = C(e), o = c.length; o--;) c[o] = "#" + a + " " + d(c[o]);
        ...
        function a(e) {
            return function(t) {
                return "label" in t && t.disabled === e || "form" in t && t.disabled === e || "form" in t && !1 === t.disabled && (t.isDisabled === e || t.isDisabled !== !e && ("label" in t || !Ee(t)) !== e)
            }
        }
        ...
        function m(e, t, n, r, o, s) {
            return r && !r[H] && (r = m(r)), o && !o[H] && (o = m(o, s)), i(function(i, s, a, l) {
                ...
                } else b = g(b === s ? b.splice(m, b.length) : b), o ? o(null, s, b, l) : Y.apply(s, b)
            })
        }
            ...
            var r = n.length > 0,
                ...
                s = function(i, s, a, l, u) {
                    ...
                    for (u && (A = s === L || s || u); h !== E && null != (c = b[h]); h++) {
                        if (o && c) {
                            for (d = 0, s || c.ownerDocument === L || (k(c), a = !I); f = e[d++];)
                                if (f(c, s || L, a)) {
                                    l.push(c);
                                    break
                                }
        ...
        var b, w, _, E, T, C, x, S, A, D, O, k, L, N, I, F, P, M, R, H = "sizzle" + 1 * new Date,
            j = e.document,
            W = 0,
            q = 0,
            B = n(),
        ...
        try {
            Y.apply($ = X.call(j.childNodes), j.childNodes), $[j.childNodes.length].nodeType
        } catch (e) {
            Y = {
        ...
        w = t.support = {}, T = t.isXML = function(e) {
            ...
            return i !== L && 9 === i.nodeType && i.documentElement ? (L = i, N = L.documentElement, I = !T(L), j !== L && (n = L.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", _e, !1) : n.attachEvent && n.attachEvent("onunload", _e)), w.attributes = r(function(e) {
            ...
            }, P = [], F = [], (w.qsa = he.test(L.querySelectorAll)) && (r(function(e) {
            ...
            })), (w.matchesSelector = he.test(M = N.matches || N.webkitMatchesSelector || N.mozMatchesSelector || N.oMatchesSelector || N.msMatchesSelector)) && r(function(e) {
                w.disconnectedMatch = M.call(e, "*"), M.call(e, "[s!='']:x"), P.push("!=", ie)
            }), F = F.length && new RegExp(F.join("|")), P = P.length && new RegExp(P.join("|")), t = he.test(N.compareDocumentPosition), R = t || he.test(N.contains) ? function(e, t) {
                ...
                return n || (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === L || e.ownerDocument === j && R(j, e) ? -1 : t === L || t.ownerDocument === j && R(j, t) ? 1 : D ? J(D, e) - J(D, t) : 0 : 4 & n ? -1 : 1)
            } : function(e, t) {
                if (e === t) return O = !0, 0;
                var n, i = 0,
                    r = e.parentNode,
                    ...
                    a = [e],
                    l = [t];
                if (!r || !o) return e === L ? -1 : t === L ? 1 : r ? -1 : o ? 1 : D ? J(D, e) - J(D, t) : 0;
                if (r === o) return s(e, t);
            ...
            if ((e.ownerDocument || e) !== L && k(e), n = n.replace(le, "='$1']"), w.matchesSelector && I && !U[n + " "] && (!P || !P.test(n)) && (!F || !F.test(n))) try {
                var i = M.call(e, n);
                if (i || w.disconnectedMatch || e.document && 11 !== e.document.nodeType) return i
            } catch (e) {}
            return t(n, L, null, [e]).length > 0
        }, t.contains = function(e, t) {
            return (e.ownerDocument || e) !== L && k(e), R(e, t)
        }, t.attr = function(e, t) {
            (e.ownerDocument || e) !== L && k(e);
            var n = _.attrHandle[t.toLowerCase()],
                i = n && G.call(_.attrHandle, t.toLowerCase()) ? n(e, t, !I) : void 0;
            ...
            var t, n = [],
                i = 0,
                r = 0;
            if (O = !w.detectDuplicates, D = !w.sortStable && e.slice(0), e.sort(V), O) {
                    ...
                    return 1 === i && 0 === r ? function(e) {
                        ...
                        if (m) {
                            ...
                            if (h = [s ? m.firstChild : m.lastChild], s && y) {
                                for (f = m, d = f[H] || (f[H] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), u = c[e] || [], p = u[0] === W && u[1], b = p && u[2], f = p && m.childNodes[p]; f = ++p && f && f[g] || (b = p = 0) || h.pop();)
                                    if (1 === f.nodeType && ++b && f === t) {
                                        c[e] = [W, p, b];
                                        break
                                    }
                            } else if (y && (f = t, d = f[H] || (f[H] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), u = c[e] || [], p = u[0] === W && u[1], b = p), !1 === b)
                                for (;
                                    (f = ++p && f && f[g] || (b = p = 0) || h.pop()) && ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++b || (y && (d = f[H] || (f[H] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), c[e] = [W, b]), f !== t)););
        ...
        return c.prototype = _.filters = _.pseudos, _.setFilters = new c, C = t.tokenize = function(e, n) {
            ...
            for (a = e, l = [], u = _.preFilter; a;) {
                ...
                for (s in _.filter) !(r = de[s].exec(a)) || u[s] && !(r = u[s](r)) || (i = r.shift(), o.push({
                    value: i,
                    type: s,
                    matches: r
                }), a = a.slice(i.length));
            ...
            var n, i = [],
                ...
                o = U[e + " "];
            if (!o) {
                for (t || (t = C(e)), n = t.length; n--;) o = v(t[n]), o[H] ? i.push(o) : r.push(o);
            ...
            if (n = n || [], 1 === f.length) {
                if (o = f[0] = f[0].slice(0), o.length > 2 && "ID" === (s = o[0]).type && w.getById && 9 === t.nodeType && I && _.relative[o[1].type]) {
                    if (!(t = (_.find.ID(s.matches[0].replace(ve, ye), t) || [])[0])) return n;
                    c && (t = t.parentNode), e = e.slice(o.shift().value.length)
                }
                for (r = de.needsContext.test(e) ? 0 : o.length; r-- && (s = o[r], !_.relative[a = s.type]);)
                    if ((l = _.find[a]) && (i = l(s.matches[0].replace(ve, ye), me.test(o[0].type) && u(t.parentNode) || t))) {
                        if (o.splice(r, 1), !(e = i.length && d(o))) return Y.apply(n, i), n;
                        break
                    }
            }
            return (c || x(e, f))(i, t, !I, n, !t || me.test(e) && u(t.parentNode) || t), n
        }, w.sortStable = H.split("").sort(V).join("") === H, w.detectDuplicates = !!O, k(), w.sortDetached = r(function(e) {
    ...
    (fe.fn.init = function(e, t, n) {
        ...
        if (n = n || Te, "string" == typeof e) {
            ...
            if (i[1]) {
                if (t = t instanceof fe ? t[0] : t, fe.merge(this, fe.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : Z, !0)), _e.test(i[1]) && fe.isPlainObject(t))
                                ...
                                var u = this,
                                    ...
                                    d = function() {
                                        ...
                                        if (!(t < s)) {
                                            ...
                                            d = e && ("object" == typeof e || "function" == typeof e) && e.then, fe.isFunction(d) ? r ? d.call(e, o(s, n, a, r), o(s, n, l, r)) : (s++, d.call(e, o(s, n, a, r), o(s, n, l, r), o(s, n, a, n.notifyWith))) : (i !== a && (u = void 0, c = [e]), (r || n.resolveWith)(u, c))
                                        }
                                    },
                                    f = r ? d : function() {
                                        try {
                                            ...
                                            fe.Deferred.exceptionHook && fe.Deferred.exceptionHook(e, f.stackTrace), t + 1 >= s && (i !== l && (u = void 0, c = [e]), n.rejectWith(u, c))
                                        }
                                    };
    ...
    fe.fn.ready = function(e) {
        ...
        ready: function(e) {
            (!0 === e ? --fe.readyWait : fe.isReady) || (fe.isReady = !0, !0 !== e && --fe.readyWait > 0 || Oe.resolveWith(Z, [fe]))
        }
    }), fe.ready.then = Oe.then, "complete" === Z.readyState || "loading" !== Z.readyState && !Z.documentElement.doScroll ? e.setTimeout(fe.ready) : (Z.addEventListener("DOMContentLoaded", c), e.addEventListener("load", c));
    ...
    fe.extend({
        ...
        data: function(e, t) {
            ...
            if (void 0 === e) {
                if (this.length && (r = Ie.get(o), 1 === o.nodeType && !Ne.get(o, "hasDataAttrs"))) {
                    for (n = s.length; n--;) s[n] && (i = s[n].name, 0 === i.indexOf("data-") && (i = fe.camelCase(i.slice(5)), f(o, i, r[i])));
        ...
        promise: function(e, t) {
            ...
            for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; s--;)(n = Ne.get(o[s], e + "queueHooks")) && n.empty && (i++, n.empty.add(a));
    ...
    fe.event = {
        ...
        add: function(e, t, n, i, r) {
            var o, s, a, l, u, c, d, f, p, h, g, m = Ne.get(e);
            if (m)
                for (n.handler && (o = n, n = o.handler, r = o.selector), r && fe.find.matchesSelector($e, r), n.guid || (n.guid = fe.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function(t) {
                        return void 0 !== fe && fe.event.triggered !== t.type ? fe.event.dispatch.apply(e, arguments) : void 0
                    }), t = (t || "").match(Ae) || [""], u = t.length; u--;) a = Ye.exec(t[u]) || [], p = g = a[1], h = (a[2] || "").split(".").sort(), p && (d = fe.event.special[p] || {}, p = (r ? d.delegateType : d.bindType) || p, d = fe.event.special[p] || {}, c = fe.extend({
                    type: p,
                    origType: g,
                    data: i,
                    handler: n,
                    ...
                    namespace: h.join(".")
                }, o), (f = l[p]) || (f = l[p] = [], f.delegateCount = 0, d.setup && !1 !== d.setup.call(e, i, h, s) || e.addEventListener && e.addEventListener(p, s)), d.add && (d.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), r ? f.splice(f.delegateCount++, 0, c) : f.push(c), fe.event.global[p] = !0)
        },
        remove: function(e, t, n, i, r) {
            var o, s, a, l, u, c, d, f, p, h, g, m = Ne.hasData(e) && Ne.get(e);
            if (m && (l = m.events)) {
                for (t = (t || "").match(Ae) || [""], u = t.length; u--;)
                    if (a = Ye.exec(t[u]) || [], p = g = a[1], h = (a[2] || "").split(".").sort(), p) {
                        for (d = fe.event.special[p] || {}, p = (i ? d.delegateType : d.bindType) || p, f = l[p] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = f.length; o--;) c = f[o], !r && g !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (f.splice(o, 1), c.selector && f.delegateCount--, d.remove && d.remove.call(e, c));
                        s && !f.length && (d.teardown && !1 !== d.teardown.call(e, h, m.handle) || fe.removeEvent(e, p, m.handle), delete l[p])
                    } else
    ...
    fe.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (!(ce.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || fe.isXMLDoc(e)))
                for (s = m(a), o = m(e), i = 0, r = o.length; i < r; i++) A(o[i], s[i]);
            if (t)
                if (n)
                    for (o = o || m(e), s = s || m(a), i = 0, r = o.length; i < r; i++) S(o[i], s[i]);
                else S(e, a);
        ...
        html: function(e) {
            return ke(this, function(e) {
                ...
                if ("string" == typeof e && !Je.test(e) && !Ve[(ze.exec(e) || ["", ""])[1].toLowerCase()]) {
        ...
        fe.fn[e] = function(e) {
            for (var n, i = [], r = fe(e), o = r.length - 1, s = 0; s <= o; s++) n = s === o ? this : this.clone(!0), fe(r[s])[t](n), ie.apply(i, n.get());
    ...
    ! function() {
        function t() {
            if (a) {
                a.style.cssText = "box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%", a.innerHTML = "", $e.appendChild(s);
                var t = e.getComputedStyle(a);
                n = "1%" !== t.top, o = "2px" === t.marginLeft, i = "4px" === t.width, a.style.marginRight = "50%", r = "4px" === t.marginRight, $e.removeChild(s), a = null
            }
        }
        var n, i, r, o, s = Z.createElement("div"),
            a = Z.createElement("div");
        a.style && (a.style.backgroundClip = "content-box", a.cloneNode(!0).style.backgroundClip = "", ce.clearCloneStyle = "content-box" === a.style.backgroundClip, s.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", s.appendChild(a), fe.extend(ce, {
    ...
    fe.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, s, a = fe.camelCase(t),
                    l = e.style;
                return t = fe.cssProps[a] || (fe.cssProps[a] = N(a) || a), s = fe.cssHooks[t] || fe.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (r = s.get(e, !1, i)) ? r : l[t] : (o = typeof n, "string" === o && (r = Re.exec(n)) && r[1] && (n = p(e, t, r), o = "number"), void(null != n && n === n && ("number" === o && (n += r && r[3] || (fe.cssNumber[a] ? "" : "px")), ce.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l[t] = n))))
            }
        },
        css: function(e, t, n, i) {
            var r, o, s, a = fe.camelCase(t);
            return t = fe.cssProps[a] || (fe.cssProps[a] = N(a) || a), s = fe.cssHooks[t] || fe.cssHooks[a], s && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = k(e, t, i)), "normal" === r && t in at && (r = at[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
        }
    }), fe.each(["height", "width"], function(e, t) {
        fe.cssHooks[t] = {
            get: function(e, n, i) {
                if (n) return !ot.test(fe.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? P(e, t, i) : We(e, st, function() {
                    return P(e, t, i)
                })
            },
            set: function(e, n, i) {
                var r, o = i && rt(e),
                    s = i && F(e, t, i, "border-box" === fe.css(e, "boxSizing", !1, o), o);
                return s && (r = Re.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n, n = fe.css(e, t)), I(e, n, s)
            }
        }
    }), fe.cssHooks.marginLeft = L(ce.reliableMarginLeft, function(e, t) {
        if (t) return (parseFloat(k(e, "marginLeft")) || e.getBoundingClientRect().left - We(e, {
            marginLeft: 0
        }, function() {
        ...
        }, nt.test(e) || (fe.cssHooks[e + t].set = I)
    }), fe.fn.extend({
        css: function(e, t) {
            return ke(this, function(e, t, n) {
                var i, r, o = {},
                    s = 0;
                if (fe.isArray(t)) {
                    for (i = rt(e), r = t.length; s < r; s++) o[t[s]] = fe.css(e, t[s], !1, i);
                    return o
                }
    ...
    fe.Animation = fe.extend(z, {
            ...
            return fe.fx.off || Z.hidden ? i.duration = 0 : i.duration = "number" == typeof i.duration ? i.duration : i.duration in fe.fx.speeds ? fe.fx.speeds[i.duration] : fe.fx.speeds._default, null != i.queue && !0 !== i.queue || (i.queue = "fx"), i.old = i.complete, i.complete = function() {
            ...
            stop: function(e, t, n) {
                ...
                return "string" != typeof e && (n = t, t = e, e = void 0), t && !1 !== e && this.queue(e || "fx", []), this.each(function() {
                    ...
                    if (r) s[r] && s[r].stop && i(s[r]);
                        ...
                        for (r in s) s[r] && s[r].stop && pt.test(r) && i(s[r]);
        ...
        fe.each(["toggle", "show", "hide"], function(e, t) {
            ...
            var e, t = 0,
                n = fe.timers;
            for (ct = fe.now(); t < n.length; t++)(e = n[t])() || n[t] !== e || n.splice(t--, 1);
            n.length || fe.fx.stop(), ct = void 0
        }, fe.fx.timer = function(e) {
            fe.timers.push(e), e() ? fe.fx.start() : fe.timers.pop()
        }, fe.fx.interval = 13, fe.fx.start = function() {
            dt || (dt = e.requestAnimationFrame ? e.requestAnimationFrame(R) : e.setInterval(fe.fx.tick, fe.fx.interval))
        }, fe.fx.stop = function() {
    ...
    var ht, gt = fe.expr.attrHandle;
    fe.fn.extend({
        attr: function(e, t) {
            return ke(this, fe.attr, e, t, arguments.length > 1)
        },
        ...
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o) return void 0 === e.getAttribute ? fe.prop(e, t, n) : (1 === o && fe.isXMLDoc(e) || (r = fe.attrHooks[t.toLowerCase()] || (fe.expr.match.bool.test(t) ? ht : void 0)), void 0 !== n ? null === n ? void fe.removeAttr(e, t) : r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : r && "get" in r && null !== (i = r.get(e, t)) ? i : (i = fe.find.attr(e, t), null == i ? void 0 : i))
        },
        attrHooks: {
            type: {
                set: function(e, t) {
    ...
    fe.fn.extend({
        prop: function(e, t) {
            return ke(this, fe.prop, e, t, arguments.length > 1)
        },
    ...
    fe.fn.extend({
        addClass: function(e) {
            ...
            if ("string" == typeof e && e)
                for (t = e.match(Ae) || []; n = this[l++];)
                    if (r = U(n), i = 1 === n.nodeType && (" " + r + " ").replace(yt, " ")) {
                        for (s = 0; o = t[s++];) i.indexOf(" " + o + " ") < 0 && (i += o + " ");
                        a = fe.trim(i), r !== a && n.setAttribute("class", a)
                    }
            return this
        },
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : fe.isFunction(e) ? this.each(function(n) {
                ...
                else void 0 !== e && "boolean" !== n || (t = U(this), t && Ne.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : Ne.get(this, "__className__") || ""))
            })
        },
        hasClass: function(e) {
            var t, n, i = 0;
            for (t = " " + e + " "; n = this[i++];)
                if (1 === n.nodeType && (" " + U(n) + " ").replace(yt, " ").indexOf(t) > -1) return !0;
            return !1
        }
    });
    var bt = /\r/g,
    ...
    fe.fn.extend({
        val: function(e) {
            ...
            })) : r ? (t = fe.valHooks[r.type] || fe.valHooks[r.nodeName.toLowerCase()], t && "get" in t && void 0 !== (n = t.get(r, "value")) ? n : (n = r.value, "string" == typeof n ? n.replace(bt, "") : null == n ? "" : n)) : void 0
        }
    }), fe.extend({
        valHooks: {
            option: {
    ...
    fe.extend(fe.event, {
        trigger: function(t, n, i, r) {
            var o, s, a, l, u, c, d, f = [i || Z],
                p = ae.call(t, "type") ? t.type : t,
                h = ae.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = a = i = i || Z, 3 !== i.nodeType && 8 !== i.nodeType && !_t.test(p + fe.event.triggered) && (p.indexOf(".") > -1 && (h = p.split("."), p = h.shift(), h.sort()), u = p.indexOf(":") < 0 && "on" + p, t = t[fe.expando] ? t : new fe.Event(p, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : fe.makeArray(n, [t]), d = fe.event.special[p] || {}, r || !d.trigger || !1 !== d.trigger.apply(i, n))) {
                if (!r && !d.noBubble && !fe.isWindow(i)) {
                    for (l = d.delegateType || p, _t.test(l + p) || (s = s.parentNode); s; s = s.parentNode) f.push(s), a = s;
                    a === (i.ownerDocument || Z) && f.push(a.defaultView || a.parentWindow || e)
                }
                for (o = 0;
                    (s = f[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? l : d.bindType || p, c = (Ne.get(s, "events") || {})[t.type] && Ne.get(s, "handle"), c && c.apply(s, n), (c = u && s[u]) && c.apply && Le(s) && (t.result = c.apply(s, n), !1 === t.result && t.preventDefault());
                return t.type = p, r || t.isDefaultPrevented() || d._default && !1 !== d._default.apply(f.pop(), n) || !Le(i) || u && fe.isFunction(i[p]) && !fe.isWindow(i) && (a = i[u], a && (i[u] = null), fe.event.triggered = p, i[p](), fe.event.triggered = void 0, a && (i[u] = a)), t.result
            }
        },
    ...
    fe.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !fe(this).is(":disabled") && Dt.test(this.nodeName) && !At.test(e) && (this.checked || !Be.test(e))
            }).map(function(e, t) {
                var n = fe(this).val();
    ...
    jt.href = Et.href, fe.extend({
        ...
        ajax: function(t, n) {
            ...
            if (v.promise(T), h.url = ((t || h.url || Et.href) + "").replace(Pt, Et.protocol + "//"), h.type = n.method || n.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(Ae) || [""], null == h.crossDomain) {
                u = Z.createElement("a");
                try {
            ...
            if (h.data && h.processData && "string" != typeof h.data && (h.data = fe.param(h.data, h.traditional)), $(Mt, h, n, T), c) return T;
            d = fe.event && h.global, d && 0 == fe.active++ && fe.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Ft.test(h.type), o = h.url.replace(kt, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Ot, "+")) : (p = h.url.slice(o.length), h.data && (o += (Ct.test(o) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (o = o.replace(Lt, ""), p = (Ct.test(o) ? "&" : "?") + "_=" + Tt++ + p), h.url = o + p), h.ifModified && (fe.lastModified[o] && T.setRequestHeader("If-Modified-Since", fe.lastModified[o]), fe.etag[o] && T.setRequestHeader("If-None-Match", fe.etag[o])), (h.data && h.hasContent && !1 !== h.contentType || n.contentType) && T.setRequestHeader("Content-Type", h.contentType), T.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Ht + "; q=0.01" : "") : h.accepts["*"]);
            for (f in h.headers) T.setRequestHeader(f, h.headers[f]);
            if (h.beforeSend && (!1 === h.beforeSend.call(g, T, h) || c)) return T.abort();
            if (E = "abort", y.add(h.complete), T.done(h.success), T.fail(h.error), r = $(Rt, h, n, T)) {
    ...
    ce.cors = !!qt && "withCredentials" in qt, ce.ajax = qt = !!qt, fe.ajaxTransport(function(t) {
        var n, i;
    ...
    fe.ajaxSetup({
        ...
        if (a || "jsonp" === t.dataTypes[0]) return r = t.jsonpCallback = fe.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(zt, "$1" + r) : !1 !== t.jsonp && (t.url += (Ct.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function() {
            return s || fe.error(r + " was not called"), s[0]
        }, t.dataTypes[0] = "json", o = e[r], e[r] = function() {
            s = arguments
        }, i.always(function() {
            void 0 === o ? fe(e).removeProp(r) : e[r] = o, t[r] && (t.jsonpCallback = n.jsonpCallback, Bt.push(r)), s && fe.isFunction(o) && o(s[0]), s = o = void 0
        }), "script"
        ...
        var i, r, o;
        return t || (ce.createHTMLDocument ? (t = Z.implementation.createHTMLDocument(""), i = t.createElement("base"), i.href = Z.location.href, t.head.appendChild(i)) : t = Z), r = _e.exec(e), o = !n && [], r ? [t.createElement(r[1])] : (r = y([e], t, o), o && o.length && fe(o).remove(), fe.merge([], r.childNodes))
    }, fe.fn.load = function(e, t, n) {
        var i, r, o, s = this,
            a = e.indexOf(" ");
        return a > -1 && (i = fe.trim(e.slice(a)), e = e.slice(0, a)), fe.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (r = "POST"), s.length > 0 && fe.ajax({
            url: e,
            type: r || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function(e, t, n) {
            var i, r, o, s, a, l, u, c = fe.css(e, "position"),
                d = fe(e),
                f = {};
            "static" === c && (e.style.position = "relative"), a = d.offset(), o = fe.css(e, "top"), l = fe.css(e, "left"), u = ("absolute" === c || "fixed" === c) && (o + l).indexOf("auto") > -1, u ? (i = d.position(), s = i.top, r = i.left) : (s = parseFloat(o) || 0, r = parseFloat(l) || 0), fe.isFunction(t) && (t = t.call(e, n, fe.extend({}, a))), null != t.top && (f.top = t.top - a.top + s), null != t.left && (f.left = t.left - a.left + r), "using" in t ? t.using.call(e, f) : d.css(f)
        }
    }, fe.fn.extend({
        offset: function(e) {
            ...
            return o ? o.getClientRects().length ? (i = o.getBoundingClientRect(), i.width || i.height ? (r = o.ownerDocument, n = X(r), t = r.documentElement, {
        ...
        fe.cssHooks[t] = L(ce.pixelPosition, function(e, n) {
            if (n) return n = k(e, t), it.test(n) ? fe(e).position()[t] + "px" : n
        })
    }), fe.each({
        Height: "height",
        Width: "width"
    ...
    return fe.noConflict = function(t) {
        return e.$ === fe && (e.$ = Vt), t && e.jQuery === fe && (e.jQuery = Ut), fe
    }, t || (e.jQuery = e.$ = fe), fe
}), function(e, t) {
    ...
    function d(e, t, n, i) {
        return $(t["offset" + e], n["client" + e], n["offset" + e], ne() ? n["offset" + e] + i["margin" + ("Height" === e ? "Top" : "Left")] + i["margin" + ("Height" === e ? "Bottom" : "Right")] : 0)
    }
    ...
    function h(e) {
        ...
        if (d || h) {
            var g = t(e);
            d -= c(g, "x"), h -= c(g, "y"), o.width -= d, o.height -= h
        }
        return p(o)
    }
    ...
    function y(e, t, r, o) {
        ...
        if ("viewport" === o) s = m(l);
            ...
            var u;
            "scrollParent" === o ? (u = i(n(e)), "BODY" === u.nodeName && (u = window.document.documentElement)) : u = "window" === o ? window.document.documentElement : o;
            var c = g(u, l);
            if ("HTML" !== u.nodeName || v(l)) s = c;
                ...
                var d = f(),
                    p = d.height,
                    h = d.width;
                s.top += c.top - c.marginTop, s.bottom = p + c.top, s.left += c.left - c.marginLeft, s.right = h + c.left
            }
        }
    ...
    function D() {
        if (!this.state.isDestroyed) {
            ...
            e.offsets.reference = _(this.state, this.popper, this.reference), e.placement = w(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.offsets.popper = C(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = "absolute", e = A(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
        }
    }
    ...
    for (var V = Math.min, G = Math.floor, $ = Math.max, Q = ["native code", "[object MutationObserverConstructor]"], K = "undefined" != typeof window, Y = ["Edge", "Trident", "Firefox"], X = 0, J = 0; J < Y.length; J += 1)
        if (K && 0 <= navigator.userAgent.indexOf(Y[J])) {
            X = 1;
            break
        }
    var Z, ee = K && function(e) {
        ...
        ce = function() {
            function t(n, i) {
                ...
                }, this.update = te(this.update.bind(this)), this.options = se({}, t.Defaults, o), this.state = {
                    isDestroyed: !1,
                    isCreated: !1,
                    scrollParents: []
                }, this.reference = n.jquery ? n[0] : n, this.popper = i.jquery ? i[0] : i, this.options.modifiers = {}, Object.keys(se({}, t.Defaults.modifiers, o.modifiers)).forEach(function(e) {
                    r.options.modifiers[e] = se({}, t.Defaults.modifiers[e] || {}, o.modifiers ? o.modifiers[e] : {})
        ...
        modifiers: {
                ...
                fn: function(e) {
                    ...
                    if (i) {
                        var r = e.offsets,
                            ...
                            c = {
                                start: oe({}, l, o[l]),
                                end: oe({}, l, o[l] + o[u] - s[u])
                            };
                        e.offsets.popper = se({}, s, c[i])
                    }
                    return e
                }
            },
                ...
                fn: function(e, t) {
                    ...
                    var o = t.priority,
                        ...
                        a = {
                            primary: function(e) {
                                var n = s[e];
                                return s[e] < i[e] && !t.escapeWithReference && (n = $(s[e], i[e])), oe({}, e, n)
                            },
                            secondary: function(e) {
                                var n = "right" === e ? "left" : "top",
                                    r = s[n];
                                return s[e] > i[e] && !t.escapeWithReference && (r = V(s[n], i[e] - ("right" === e ? s.width : s.height))), oe({}, n, r)
                            }
                        };
            ...
            arrow: {
                ...
                fn: function(e, t) {
                    ...
                    var i = e.placement.split("-")[0],
                        ...
                        d = a ? "bottom" : "right",
                        f = E(n)[l];
                    s[d] - f < o[u] && (e.offsets.popper[u] -= o[u] - (s[d] - f)), s[u] + f > o[d] && (e.offsets.popper[u] += s[u] + f - o[d]);
                    var h = s[u] + s[l] / 2 - f / 2,
                        g = h - p(e.offsets.popper)[u];
                    return g = $(V(o[l] - f, g), 0), e.arrowElement = n, e.offsets.arrow = {}, e.offsets.arrow[u] = Math.round(g), e.offsets.arrow[c] = "", e
                },
                element: "[x-arrow]"
            },
            flip: {
                ...
                fn: function(e, t) {
                    ...
                    return s.forEach(function(a, l) {
                        ...
                        (f || v || b) && (e.flipped = !0, (f || v) && (i = s[l + 1]), b && (o = q(o)), e.placement = i + (o ? "-" + o : ""), e.offsets.popper = se({}, e.offsets.popper, C(e.instance.popper, e.offsets.reference, e.placement)), e = A(e.instance.modifiers, e, "flip"))
                    }), e
                },
                behavior: "flip",
                padding: 5,
            ...
            inner: {
                ...
                fn: function(e) {
                    ...
                    return r[s ? "left" : "top"] = o[t] - (a ? r[s ? "width" : "height"] : 0), e.placement = T(t), e.offsets.popper = p(r), e
                }
            },
            hide: {
                order: 800,
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    ...
                    var a, l, u = void 0 === s ? t.gpuAcceleration : s,
                        ...
                        v = k("transform");
                    if (l = "bottom" == g ? -d.height + p.bottom : p.top, a = "right" == m ? -d.width + p.right : p.left, u && v) f[v] = "translate3d(" + a + "px, " + l + "px, 0)", f[g] = 0, f[m] = 0, f.willChange = "transform";
                    else {
                        var y = "bottom" == g ? -1 : 1,
                            b = "right" == m ? -1 : 1;
                    ...
                    return e.attributes = se({}, w, e.attributes), e.styles = se({}, f, e.styles), e
                },
                gpuAcceleration: !0,
                x: "bottom",
                y: "right"
            ...
            applyStyle: {
                ...
                enabled: !0,
                fn: function(e) {
                    return H(e.instance.popper, e.styles), j(e.instance.popper, e.attributes), e.offsets.arrow && H(e.arrowElement, e.offsets.arrow), e
                },
...
var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
    ...
    s = (function(e) {
        ...
        e(document).on(a.CLICK_DATA_API, s.DISMISS, u._handleDismiss(new u)), e.fn[t] = u._jQueryInterface, e.fn[t].Constructor = u, e.fn[t].noConflict = function() {
        ...
        var t = "button",
            ...
            l = function() {
                ...
                return t.prototype.toggle = function() {
                    ...
                    if (i) {
                        var r = e(this._element).find(s.INPUT)[0];
                        if (r) {
                            if ("radio" === r.type)
        ...
        e(document).on(a.CLICK_DATA_API, s.DATA_TOGGLE_CARROT, function(t) {
            t.preventDefault();
            var n = t.target;
            e(n).hasClass(o.BUTTON) || (n = e(n).closest(s.BUTTON)), l._jQueryInterface.call(e(n), "toggle")
            ...
            g = function() {
                ...
                return l.prototype.next = function() {
                    ...
                    var i = this,
                        ...
                        g = void 0,
                        m = void 0;
                    if (t === d.NEXT ? (c = p.LEFT, g = p.NEXT, m = d.LEFT) : (c = p.RIGHT, g = p.PREV, m = d.RIGHT), a && e(a).hasClass(p.ACTIVE)) return void(this._isSliding = !1);
                    if (!this._triggerSlideEvent(a, m).isDefaultPrevented() && r && a) {
                        ...
                        o.supportsTransitionEnd() && e(this._element).hasClass(p.SLIDE) ? (e(a).addClass(g), o.reflow(a), e(r).addClass(c), e(a).addClass(c), e(r).one(o.TRANSITION_END, function() {
                            e(a).removeClass(c + " " + g).addClass(p.ACTIVE), e(r).removeClass(p.ACTIVE + " " + g + " " + c), i._isSliding = !1, setTimeout(function() {
                                return e(i._element).trigger(v)
                            }, 0)
                        }).emulateTransitionEnd(600)) : (e(r).removeClass(p.ACTIVE), e(a).addClass(p.ACTIVE), this._isSliding = !1, e(this._element).trigger(v)), u && this.cycle()
                    }
                    ...
                    return this.each(function() {
                        ...
                        if (n || (n = new l(this, r), e(this).data(s, n)), "number" == typeof t) n.to(t);
        ...
        var t = "collapse",
            ...
            h = function() {
                function a(t, i) {
                    ...
                    for (var r = e(p.DATA_TOGGLE), s = 0; s < r.length; s++) {
                        var l = r[s],
                ...
                return a.prototype.toggle = function() {
                    ...
                    if (!this._isTransitioning && !e(this._element).hasClass(d.SHOW)) {
                        var n = void 0,
                            i = void 0;
                        if (this._parent && (n = e.makeArray(e(this._parent).children().children(p.ACTIVES)), n.length || (n = null)), !(n && (i = e(n).data(s)) && i._isTransitioning)) {
                            ...
                            if (e(this._element).trigger(r), !r.isDefaultPrevented()) {
                                ...
                                var f = l[0].toUpperCase() + l.slice(1),
                                    h = "scroll" + f;
                                e(this._element).one(o.TRANSITION_END, u).emulateTransitionEnd(600), this._element.style[l] = this._element[h] + "px"
                            }
                        }
                    }
                        ...
                        if (e(this._element).trigger(n), !n.isDefaultPrevented()) {
                            ...
                            if (this._element.style[i] = this._element.getBoundingClientRect()[i] + "px", o.reflow(this._element), e(this._element).addClass(d.COLLAPSING).removeClass(d.COLLAPSE).removeClass(d.SHOW), this._triggerArray.length)
                                for (var r = 0; r < this._triggerArray.length; r++) {
                                    ...
                                    if (null !== a) {
                                        var l = e(a);
                                        l.hasClass(d.SHOW) || e(s).addClass(d.COLLAPSED).attr("aria-expanded", !1)
                                    }
                                }
                            ...
                            if (this._element.style[i] = "", !o.supportsTransitionEnd()) return void u();
                    ...
                    return this.each(function() {
                        ...
                        if (!r && o.toggle && /show|hide/.test(t) && (o.toggle = !1), r || (r = new a(this, o), n.data(s, r)), "string" == typeof t) {
            ...
            m = function() {
                ...
                return l.prototype.toggle = function() {
                    ...
                    return this.each(function() {
                        ...
                        if (n || (n = new l(this, r), e(this).data(s, n)), "string" == typeof t) {
                        ...
                        for (var n = e.makeArray(e(f.DATA_TOGGLE)), i = 0; i < n.length; i++) {
                            ...
                            if (o) {
                                ...
                                if (e(r).hasClass(d.SHOW) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && e.contains(r, t.target))) {
                                    ...
                                    e(r).trigger(p), p.isDefaultPrevented() || ("ontouchstart" in document.documentElement && e("body").children().off("mouseover", null, e.noop), n[i].setAttribute("aria-expanded", "false"), e(u).removeClass(d.SHOW), e(r).removeClass(d.SHOW).trigger(e.Event(c.HIDDEN, a)))
                                }
                            }
                        }
                    ...
                    if (!(!u.test(t.which) || /button/i.test(t.target.tagName) && 32 === t.which || /input|textarea/i.test(t.target.tagName) || (t.preventDefault(), t.stopPropagation(), this.disabled || e(this).hasClass(d.DISABLED)))) {
                        ...
                        if (!i && (27 !== t.which || 32 !== t.which) || i && (27 === t.which || 32 === t.which)) {
                            if (27 === t.which) {
                                var r = e(n).find(f.DATA_TOGGLE)[0];
                                e(r).trigger("focus")
                            }
        ...
        e(document).on(c.KEYDOWN_DATA_API, f.DATA_TOGGLE, m._dataApiKeydownHandler).on(c.KEYDOWN_DATA_API, f.MENU, m._dataApiKeydownHandler).on(c.CLICK_DATA_API + " " + c.KEYUP_DATA_API, m._clearMenus).on(c.CLICK_DATA_API, f.DATA_TOGGLE, function(t) {
        ...
        var t = "modal",
            ...
            p = function() {
                function a(t, i) {
                    n(this, a), this._config = this._getConfig(i), this._element = t, this._dialog = e(t).find(f.DIALOG)[0], this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._originalBodyPadding = 0, this._scrollbarWidth = 0
                }
                return a.prototype.toggle = function(e) {
                    ...
                    if (!this._isTransitioning) {
                        o.supportsTransitionEnd() && e(this._element).hasClass(d.FADE) && (this._isTransitioning = !0);
                    ...
                    if (t && t.preventDefault(), !this._isTransitioning && this._isShown) {
                        var i = o.supportsTransitionEnd() && e(this._element).hasClass(d.FADE);
                        i && (this._isTransitioning = !0);
                        var r = e.Event(c.HIDE);
                        e(this._element).trigger(r), this._isShown && !r.isDefaultPrevented() && (this._isShown = !1, this._setEscapeEvent(), this._setResizeEvent(), e(document).off(c.FOCUSIN), e(this._element).removeClass(d.SHOW), e(this._element).off(c.CLICK_DISMISS), e(this._dialog).off(c.MOUSEDOWN_DISMISS), i ? e(this._element).one(o.TRANSITION_END, function(e) {
                    ...
                    var n = this,
                        i = o.supportsTransitionEnd() && e(this._element).hasClass(d.FADE);
                    this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.scrollTop = 0, i && o.reflow(this._element), e(this._element).addClass(d.SHOW), this._config.focus && this._enforceFocus();
                    ...
                    if (this._isShown && this._config.backdrop) {
                        ...
                        if (this._backdrop = document.createElement("div"), this._backdrop.className = d.BACKDROP, i && e(this._backdrop).addClass(i), e(this._backdrop).appendTo(document.body), e(this._element).on(c.CLICK_DISMISS, function(e) {
                            ...
                            }), r && o.reflow(this._backdrop), e(this._backdrop).addClass(d.SHOW), !t) return;
                        if (!r) return void t();
                        ...
                        o.supportsTransitionEnd() && e(this._element).hasClass(d.FADE) ? e(this._backdrop).one(o.TRANSITION_END, s).emulateTransitionEnd(150) : s()
                    } else t && t()
                ...
                return s.prototype.refresh = function() {
                    ...
                    this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), e.makeArray(e(this._selector)).map(function(t) {
                        ...
                        if (s && (n = e(s)[0]), n) {
                            ...
                            if (a.width || a.height) return [e(n)[i]().top + r, s]
                        }
                        return null
                    }).filter(function(e) {
                        return e
                    ...
                    if (n = e.extend({}, a, n), "string" != typeof n.target) {
                    ...
                    var i = e(n.join(","));
                    i.hasClass(c.DROPDOWN_ITEM) ? (i.closest(d.DROPDOWN).find(d.DROPDOWN_TOGGLE).addClass(c.ACTIVE), i.addClass(c.ACTIVE)) : (i.addClass(c.ACTIVE), i.parents(d.NAV_LIST_GROUP).prev(d.NAV_LINKS + ", " + d.LIST_ITEMS).addClass(c.ACTIVE)), e(this._scrollElement).trigger(u.ACTIVATE, {
                        relatedTarget: t
                    })
                    ...
                    return this.each(function() {
                        ...
                        if (n || (n = new s(this, r), e(this).data("bs.scrollspy", n)), "string" == typeof t) {
                            if (void 0 === n[t]) throw new Error('No method named "' + t + '"');
                            n[t]()
                        }
                    })
            ...
            l = function() {
                ...
                return t.prototype.show = function() {
                    ...
                    if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && e(this._element).hasClass(s.ACTIVE) || e(this._element).hasClass(s.DISABLED))) {
                        ...
                        l && (r = e.makeArray(e(l).find(a.ACTIVE)), r = r[r.length - 1]);
                        ...
                        if (r && e(r).trigger(c), e(this._element).trigger(d), !d.isDefaultPrevented() && !c.isDefaultPrevented()) {
                    ...
                    var r = this,
                        ...
                        u = i && o.supportsTransitionEnd() && l && e(l).hasClass(s.FADE),
                        c = function() {
                            return r._transitionComplete(t, l, u, i)
                        };
                    l && u ? e(l).one(o.TRANSITION_END, c).emulateTransitionEnd(150) : c(), l && e(l).removeClass(s.SHOW)
                    ...
                    if (e(t).addClass(s.ACTIVE), t.setAttribute("aria-expanded", !0), i ? (o.reflow(t), e(t).addClass(s.SHOW)) : e(t).removeClass(s.FADE), t.parentNode && e(t.parentNode).hasClass(s.DROPDOWN_MENU)) {
                        var u = e(t).closest(a.DROPDOWN)[0];
                        u && e(u).find(a.DROPDOWN_TOGGLE).addClass(s.ACTIVE), t.setAttribute("aria-expanded", !0)
                    }
                    r && r()
                }, t._jQueryInterface = function(n) {
                    return this.each(function() {
            ...
            v = function() {
                ...
                return a.prototype.enable = function() {
                    ...
                    if (this.isWithContent() && this._isEnabled) {
                        ...
                        o.supportsTransitionEnd() && e(this.tip).hasClass(h.FADE) ? e(this.tip).one(o.TRANSITION_END, d).emulateTransitionEnd(a._TRANSITION_DURATION) : d()
                    }
                }, a.prototype.hide = function(t) {
                    var n = this,
                    ...
                    e(this.element).trigger(r), r.isDefaultPrevented() || (e(i).removeClass(h.SHOW), "ontouchstart" in document.documentElement && e("body").children().off("mouseover", null, e.noop), this._activeTrigger[m.CLICK] = !1, this._activeTrigger[m.FOCUS] = !1, this._activeTrigger[m.HOVER] = !1, o.supportsTransitionEnd() && e(this.tip).hasClass(h.FADE) ? e(i).one(o.TRANSITION_END, s).emulateTransitionEnd(150) : s(), this._hoverState = "")
...
! function(o) {
    var a = "popover",
        ...
        d = o.extend({}, s.Default, {
            placement: "right",
            trigger: "click",
            content: "",
            template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
        }),
        f = o.extend({}, s.DefaultType, {
        ...
        m = function(s) {
            ...
            return t(u, s), u.prototype.isWithContent = function() {
                ...
                return this.each(function() {
                    ...
                    if ((t || !/destroy|hide/.test(e)) && (t || (t = new u(this, n), o(this).data("bs.popover", t)), "string" == typeof e)) {
    ...
    o.fn[a] = m._jQueryInterface, o.fn[a].Constructor = m, o.fn[a].noConflict = function() {
        return o.fn[a] = u, m._jQueryInterface
    }
}(jQuery)
}(),
function(e, t) {
...
var t = function(e, t) {
    ...
    n = function(e, t) {
        ...
        if (Array.prototype.map && e.map === Array.prototype.map) r = Array.prototype.map.call(e, function(e) {
            ...
            for (n = 0; n < o; n++) callback_params = i, callback_params.splice(0, 0, e[n]), r.push(t.apply(this, callback_params));
        return r
    },
    i = function(e) {
        var t, n = [];
    ...
    o = function(e, t) {
        var n;
        for (n = 0; n < e.length; n++) e[n] instanceof google.maps.LatLng || (e[n].length > 0 && "object" == typeof e[n][0] ? e[n] = o(e[n], t) : e[n] = r(e[n], t));
        return e
    },
    s = function(e, t) {
        var n = e.replace(".", "");
    ...
    u = function(e) {
        ...
        var n = document,
            i = function(e) {
                ...
                if ("string" == typeof e.el || "string" == typeof e.div ? p.indexOf("#") > -1 ? this.el = a(p, e.context) : this.el = s.apply(this, [p, e.context]) : this.el = p, void 0 === this.el || null === this.el) throw "No element defined.";
                ...
                for (1 != e.disableDefaultUI && (A = t(A, D)), S = t(A, e), r = 0; r < c.length; r++) delete S[c[r]];
                for (r = 0; r < d.length; r++) delete S[d[r]];
                this.map = new google.maps.Map(this.el, S), h && (this.markerClusterer = h.apply(this, [this.map]));
                var O = function(e, t) {
                    var n = "",
                        i = window.context_menu[u.el.id][e];
                    for (var r in i)
                    ...
                    if (a("gmaps_context_menu")) {
                        ...
                        for (r = 0; r < d; r++) {
                            var f = c[r],
                                p = function(n) {
                                    n.preventDefault(), i[this.id.replace(e + "_", "")].action.apply(u, [t]), u.hideContextMenu()
                                };
                            google.maps.event.clearListeners(f, "click"), google.maps.event.addDomListenerOnce(f, "click", p, !1)
                        }
                ...
                this.buildContextMenu = function(e, t) {
                    if ("marker" === e) {
                        ...
                        n.setMap(u.map), n.draw = function() {
                            ...
                            t.pixel = i.fromLatLngToContainerPixel(r), O(e, t)
                        }
                    } else O(e, t);
                ...
                var I, F = [];
                for (I in this.map) "function" != typeof this.map[I] || this[I] || F.push(I);
                for (r = 0; r < F.length; r++) ! function(e, t, n) {
                    e[n] = function() {
...
u.prototype.createControl = function(e) {
    ...
    for (var d = ["animation_changed", "clickable_changed", "cursor_changed", "draggable_changed", "flat_changed", "icon_changed", "position_changed", "shadow_changed", "shape_changed", "title_changed", "visible_changed", "zindex_changed"], f = ["dblclick", "drag", "dragend", "dragstart", "mousedown", "mouseout", "mouseover", "mouseup"], c = 0; c < d.length; c++) ! function(t, n) {
        e[n] && google.maps.event.addListener(t, n, function() {
            e[n].apply(this, [this])
        })
    }(l, d[c]);
    for (var c = 0; c < f.length; c++) ! function(t, n, i) {
    ...
    return t.setMap(this.map), null != e.auto_show && (n = e.auto_show), t.onAdd = function() {
        ...
        r.appendChild(n);
        for (var s = 0; s < o.length; s++) ! function(e, t) {
        ...
        var i = this.getProjection(),
            r = i.fromLatLngToDivPixel(new google.maps.LatLng(e.lat, e.lng));
        ...
        switch (e.verticalAlign) {
            case "top":
                o.style.top = r.y - a + e.verticalOffset + "px";
                break;
            default:
            case "middle":
                o.style.top = r.y - a / 2 + e.verticalOffset + "px";
                break;
            case "bottom":
                o.style.top = r.y + e.verticalOffset + "px"
        }
        switch (e.horizontalAlign) {
            case "left":
                o.style.left = r.x - l + e.horizontalOffset + "px";
                break;
            default:
            case "center":
                o.style.left = r.x - l / 2 + e.horizontalOffset + "px";
                break;
            case "right":
                o.style.left = r.x + e.horizontalOffset + "px"
        }
    ...
    for (var s = new google.maps.Polyline(o), a = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], l = 0; l < a.length; l++) ! function(t, n) {
    ...
    for (var n = new google.maps.Circle(e), i = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], r = 0; r < i.length; r++) ! function(t, n) {
        e[n] && google.maps.event.addListener(t, n, function(t) {
            e[n].apply(this, [t])
        })
    }(n, i[r]);
    ...
    e.bounds = n;
    for (var i = new google.maps.Rectangle(e), r = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], o = 0; o < r.length; o++) ! function(t, n) {
        e[n] && google.maps.event.addListener(t, n, function(t) {
            e[n].apply(this, [t])
        })
    }(i, r[o]);
...
return u.prototype.getRoutes = function(e) {
    ...
    var i, r = "string" == typeof n.panel ? document.getElementById(n.panel.replace("#", "")) : n.panel;
    n.panel = r, n = t({
        map: this.map
    ...
    if (e.origin && e.destination) this.getRoutes({
        ...
        callback: function(t) {
            if (t.length > 0 && e.start && e.start(t[t.length - 1]), t.length > 0 && e.step) {
                var n = t[t.length - 1];
                if (n.legs.length > 0)
                    for (var i, r = n.legs[0].steps, o = 0; i = r[o]; o++) i.step_number = o, e.step(i, n.legs[0].steps.length - 1)
            }
    ...
    if (e.origin && e.destination) this.getRoutes({
        ...
        callback: function(n) {
            if (n.length > 0 && e.start && e.start(n[n.length - 1]), n.length > 0 && e.step) {
                var i = n[n.length - 1];
                if (i.legs.length > 0)
                    for (var r, o = i.legs[0].steps, s = 0; r = o[s]; s++) {
                        r.step_number = s;
                        var a = {
                            path: r.path,
                            strokeColor: e.strokeColor,
                        ...
                        e.hasOwnProperty("icons") && (a.icons = e.icons), t.drawPolyline(a), e.step(r, i.legs[0].steps.length - 1)
                    }
            }
    ...
    var u = e.size;
    u ? (u.join && (u = u.join("x")), delete e.size) : u = "630x300", i.push("size=" + u), e.zoom || !1 === e.zoom || (e.zoom = 15);
    var c = !e.hasOwnProperty("sensor") || !!e.sensor;
    delete e.sensor, i.push("sensor=" + c);
    for (var d in e) e.hasOwnProperty(d) && i.push(d + "=" + e[d]);
    if (o)
        for (var f, p, h = 0; n = o[h]; h++) {
            f = [], n.size && "normal" !== n.size ? (f.push("size:" + n.size), delete n.size) : n.icon && (f.push("icon:" + encodeURI(n.icon)), delete n.icon), n.color && (f.push("color:" + n.color.replace("#", "0x")), delete n.color), n.label && (f.push("label:" + n.label[0].toUpperCase()), delete n.label), p = n.address ? n.address : n.lat + "," + n.lng, delete n.address, delete n.lat, delete n.lng;
            for (var d in n) n.hasOwnProperty(d) && f.push(d + ":" + n[d]);
            f.length || 0 === h ? (f.push(p), f = f.join("|"), i.push("markers=" + encodeURI(f))) : (f = i.pop() + encodeURI("|" + p), i.push(f))
        }
    if (s)
        for (var h = 0; h < s.length; h++) {
            ...
            for (var m = 0; m < s[h].stylers.length; m++)
                for (var v in s[h].stylers[m]) {
                    var y = s[h].stylers[m][v];
    ...
    if (a) {
        ...
        if (n.fillColor) {
            var _ = t(n.fillColor, n.fillOpacity);
            a.push("fillcolor:" + _)
        }
        var E = n.path;
        if (E.join)
            for (var T, m = 0; T = E[m]; m++) a.push(T.join(","));
        else a.push("enc:" + E);
    ...
    for (var i = ["closeclick", "links_changed", "pano_changed", "position_changed", "pov_changed", "resize", "visible_changed"], r = t({
            visible: !0
        }, e), o = 0; o < i.length; o++) delete r[i[o]];
    for (var s = new google.maps.StreetViewPanorama(n, r), o = 0; o < i.length; o++) ! function(t, n) {
        e[n] && google.maps.event.addListener(t, n, function() {
            e[n].apply(this)
        })
    }(s, i[o]);
    ...
    if (-1 == u.custom_events.indexOf(e)) return t instanceof u && (t = t.map), google.maps.event.addListenerOnce(t, e, n)
    ...
    for (var n = !1, i = this.getPaths().getLength(), r = 0; r < i; r++)
        for (var o = this.getPaths().getAt(r), s = o.getLength(), a = s - 1, l = 0; l < s; l++) {
            var u = o.getAt(l),
                c = o.getAt(a);
...
i.getListeners = function(e) {
    ...
    for (r in o)
        if (o.hasOwnProperty(r))
            for (i = o[r].length; i--;) n = o[r][i], !0 === n.once && this.removeListener(e, n.listener), n.listener.apply(this, t || []) === this._getOnceReturnValue() && this.removeListener(e, n.listener);
    return this
    ...
    e.flexslider = function(t, n) {
        ...
        e.data(t, "flexslider", i), g = {
            init: function() {
                ...
                }), i.vars.pauseInvisible && g.pauseInvisible.isHidden() || (i.vars.initDelay > 0 ? i.startTimeout = setTimeout(i.play, i.vars.initDelay) : i.play())), h && g.asNav.setup(), a && i.vars.touch && g.touch(), (!p || p && i.vars.smoothHeight) && e(window).bind("resize orientationchange focus", g.resize), i.find("img").attr("draggable", "false"), setTimeout(function() {
                    i.vars.start(i)
                }, 200)
            },
            asNav: {
                setup: function() {
                    i.asNav = !0, i.animatingTo = Math.floor(i.currentSlide / i.move), i.currentItem = i.currentSlide, i.slides.removeClass(o + "active-slide").eq(i.currentItem).addClass(o + "active-slide"), s ? (t._slider = i, i.slides.each(function() {
                        ...
                        var n = e(this),
                            r = n.index();
                        n.offset().left - e(i).scrollLeft() <= 0 && n.hasClass(o + "active-slide") ? i.flexAnimate(i.getTarget("prev"), !0) : e(i.vars.asNavFor).data("flexslider").animating || n.hasClass(o + "active-slide") || (i.direction = i.currentItem < r ? "next" : "prev", i.flexAnimate(r, i.vars.pauseOnAction, !1, !0, !0))
                    })
                }
            },
            controlNav: {
                ...
                setupPaging: function() {
                    ...
                    if (i.controlNavScaffold = e('<ol class="' + o + "control-nav " + o + r + '"></ol>'), i.pagingCount > 1)
                        for (var a = 0; a < i.pagingCount; a++) {
                            if (n = i.slides.eq(a), t = "thumbnails" === i.vars.controlNav ? '<img src="' + n.attr("data-thumb") + '"/>' : "<a>" + s + "</a>", "thumbnails" === i.vars.controlNav && !0 === i.vars.thumbCaptions) {
                ...
                setupManual: function() {
                    i.controlNav = i.manualControls, g.controlNav.active(), i.controlNav.bind(l, function(t) {
                        if (t.preventDefault(), "" === u || u === t.type) {
                            var n = e(this),
                                r = i.controlNav.index(n);
                            n.hasClass(o + "active") || (r > i.currentSlide ? i.direction = "next" : i.direction = "prev", i.flexAnimate(r, i.vars.pauseOnAction))
                        }
                        "" === u && (u = t.type), g.setToClearWatchedEvent()
                    })
                },
            ...
            directionNav: {
                setup: function() {
                    ...
                    i.controlsContainer ? (e(i.controlsContainer).append(t), i.directionNav = e("." + o + "direction-nav li a", i.controlsContainer)) : (i.append(t), i.directionNav = e("." + o + "direction-nav li a", i)), g.directionNav.update(), i.directionNav.bind(l, function(t) {
                        t.preventDefault();
                        var n;
                        "" !== u && u !== t.type || (n = e(this).hasClass(o + "next") ? i.getTarget("next") : i.getTarget("prev"), i.flexAnimate(n, i.vars.pauseOnAction)), "" === u && (u = t.type), g.setToClearWatchedEvent()
                    })
                },
                update: function() {
                    var e = o + "disabled";
            ...
            pausePlay: {
                setup: function() {
                    ...
                    i.controlsContainer ? (i.controlsContainer.append(t), i.pausePlay = e("." + o + "pauseplay a", i.controlsContainer)) : (i.append(t), i.pausePlay = e("." + o + "pauseplay a", i)), g.pausePlay.update(i.vars.slideshow ? o + "pause" : o + "play"), i.pausePlay.bind(l, function(t) {
                        t.preventDefault(), "" !== u && u !== t.type || (e(this).hasClass(o + "pause") ? (i.manualPause = !0, i.manualPlay = !1, i.pause()) : (i.manualPause = !1, i.manualPlay = !0, i.play())), "" === u && (u = t.type), g.setToClearWatchedEvent()
                    })
                },
                update: function(e) {
            ...
            touch: function() {
                ...
                function n(e) {
                    w = e.touches[0].pageX, _ = e.touches[0].pageY, v = c ? u - _ : u - w, b = c ? Math.abs(v) < Math.abs(w - h) : Math.abs(v) < Math.abs(_ - h);
                    (!b || Number(new Date) - y > 500) && (e.preventDefault(), !p && i.transitions && (i.vars.animationLoop || (v /= 0 === i.currentSlide && v < 0 || i.currentSlide === i.last && v > 0 ? Math.abs(v) / m + 2 : 1), i.setProps(g + v, "setTouch")))
                }
                ...
                function r(e) {
                    if (t.removeEventListener("touchmove", n, !1), i.animatingTo === i.currentSlide && !b && null !== v) {
                        ...
                        i.canAdvance(s) && (Number(new Date) - y < 550 && Math.abs(o) > 50 || Math.abs(o) > m / 2) ? i.flexAnimate(s, i.vars.pauseOnAction) : p || i.flexAnimate(i.currentSlide, i.vars.pauseOnAction, !0)
                    }
                    t.removeEventListener("touchend", r, !1), u = null, h = null, v = null, g = null
                }

                function o(e) {
                    e.stopPropagation(), i.animating ? e.preventDefault() : (i.pause(), t._gesture.addPointer(e.pointerId), E = 0, m = c ? i.h : i.w, y = Number(new Date), g = f && d && i.animatingTo === i.last ? 0 : f && d ? i.limit - (i.itemW + i.vars.itemMargin) * i.move * i.animatingTo : f && i.currentSlide === i.last ? i.limit : f ? (i.itemW + i.vars.itemMargin) * i.move * i.currentSlide : d ? (i.last - i.currentSlide + i.cloneOffset) * m : (i.currentSlide + i.cloneOffset) * m)
                }
                ...
                function a(e) {
                    ...
                    if (n) {
                        var i = -e.translationX,
                            r = -e.translationY;
                        if (E += c ? r : i, v = E, b = c ? Math.abs(E) < Math.abs(-i) : Math.abs(E) < Math.abs(-r), e.detail === e.MSGESTURE_FLAG_INERTIA) return void setImmediate(function() {
                            t._gesture.stop()
                        });
                        (!b || Number(new Date) - y > 500) && (e.preventDefault(), !p && n.transitions && (n.vars.animationLoop || (v = E / (0 === n.currentSlide && E < 0 || n.currentSlide === n.last && E > 0 ? Math.abs(E) / m + 2 : 1)), n.setProps(g + v, "setTouch")))
                    }
                }
                ...
                function l(e) {
                    ...
                    if (t) {
                        if (t.animatingTo === t.currentSlide && !b && null !== v) {
                            ...
                            t.canAdvance(i) && (Number(new Date) - y < 550 && Math.abs(n) > 50 || Math.abs(n) > m / 2) ? t.flexAnimate(i, t.vars.pauseOnAction) : p || t.flexAnimate(t.currentSlide, t.vars.pauseOnAction, !0)
                        }
                        u = null, h = null, v = null, g = null, E = 0
                    }
                }
                var u, h, g, m, v, y, b = !1,
                    w = 0,
                    _ = 0,
                    E = 0;
                s ? (t.style.msTouchAction = "none", t._gesture = new MSGesture, t._gesture.target = t, t.addEventListener("MSPointerDown", o, !1), t._slider = i, t.addEventListener("MSGestureChange", a, !1), t.addEventListener("MSGestureEnd", l, !1)) : t.addEventListener("touchstart", e, !1)
            },
            resize: function() {
                !i.animating && i.is(":visible") && (f || i.doMath(), p ? g.smoothHeight() : f ? (i.slides.width(i.computedW), i.update(i.pagingCount), i.setProps()) : c ? (i.viewport.height(i.h), i.setProps(i.h, "setTotal")) : (i.vars.smoothHeight && g.smoothHeight(), i.newSlides.width(i.computedW), i.setProps(i.computedW, "setTotal")))
            },
        ...
        }, i.flexAnimate = function(t, n, r, s, l) {
            if (!i.vars.animationLoop && t !== i.currentSlide && (i.direction = t > i.currentSlide ? "next" : "prev"), h && 1 === i.pagingCount && (i.direction = i.currentItem < t ? "next" : "prev"), !i.animating && (i.canAdvance(t, l) || r) && i.is(":visible")) {
                if (h && s) {
                    ...
                    if (i.atEnd = 0 === t || t === i.count - 1, u.flexAnimate(t, !0, !1, !0, l), i.direction = i.currentItem < t ? "next" : "prev", u.direction = i.direction, Math.ceil((t + 1) / i.visible) - 1 === i.currentSlide || 0 === t) return i.currentItem = t, i.slides.removeClass(o + "active-slide").eq(t).addClass(o + "active-slide"), !1;
                    i.currentItem = t, i.slides.removeClass(o + "active-slide").eq(t).addClass(o + "active-slide"), t = Math.floor(t / i.visible)
                }
                if (i.animating = !0, i.animatingTo = t, n && i.pause(), i.vars.before(i), i.syncExists && !l && g.sync("animate"), i.vars.controlNav && g.controlNav.active(), f || i.slides.removeClass(o + "active-slide").eq(t).addClass(o + "active-slide"), i.atEnd = 0 === t || t === i.last, i.vars.directionNav && g.directionNav.update(), t === i.last && (i.vars.end(i), i.vars.animationLoop || i.pause()), p) a ? (i.slides.eq(i.currentSlide).css({
                    opacity: 0,
                    zIndex: 1
                }), i.slides.eq(t).css({
                    opacity: 1,
            ...
            if (p) i.slides.css({
                ...
                "init" === t && (i.viewport = e('<div class="' + o + 'viewport"></div>').css({
                    overflow: "hidden",
                    position: "relative"
                }).appendTo(i).append(i.container), i.cloneCount = 0, i.cloneOffset = 0, d && (r = e.makeArray(i.slides).reverse(), i.slides = e(r), i.container.empty().append(i.slides))), i.vars.animationLoop && !f && (i.cloneCount = 2, i.cloneOffset = 1, "init" !== t && i.container.find(".clone").remove(), i.container.append(i.slides.first().clone().addClass("clone").attr("aria-hidden", "true")).prepend(i.slides.last().clone().addClass("clone").attr("aria-hidden", "true"))), i.newSlides = e(i.vars.selector, i), n = d ? i.count - 1 - i.currentSlide + i.cloneOffset : i.currentSlide + i.cloneOffset, c && !f ? (i.container.height(200 * (i.count + i.cloneCount) + "%").css("position", "absolute").width("100%"), setTimeout(function() {
                    i.newSlides.css({
                        display: "block"
            ...
            f || i.slides.removeClass(o + "active-slide").eq(i.currentSlide).addClass(o + "active-slide")
        }, i.doMath = function() {
            ...
            var r = e(t);
            i.count += 1, i.last = i.count - 1, c && d ? void 0 !== n ? i.slides.eq(i.count - n).after(r) : i.container.prepend(r) : void 0 !== n ? i.slides.eq(n).before(r) : i.container.append(r), i.update(n, "add"), i.slides = e(i.vars.selector + ":not(.clone)", i), i.setup(), i.vars.added(i)
        }, i.removeSlide = function(t) {
            var n = isNaN(t) ? i.slides.index(e(t)) : t;
            i.count -= 1, i.last = i.count - 1, isNaN(t) ? e(t, i.slides).remove() : c && d ? i.slides.eq(i.last).remove() : i.slides.eq(t).remove(), i.doMath(), i.update(n, "remove"), i.slides = e(i.vars.selector + ":not(.clone)", i), i.setup(), i.vars.removed(i)
        }, g.init()
    ...
    e.extend(e.fn, {
        ...
        rules: function(t, n) {
            ...
            if (t) {
                ...
                switch (t) {
                    case "add":
                        e.extend(s, e.validator.normalizeRule(n)), delete s.messages, o[i.name] = s, n.messages && (r.messages[i.name] = e.extend(r.messages[i.name], n.messages));
                        break;
                    case "remove":
        ...
        attributeRules: function(t) {
            ...
            for (var o in e.validator.methods) {
                var s;
                "required" === o ? (s = i.get(0).getAttribute(o), "" === s && (s = !0), s = !!s) : s = i.attr(o), /min|max/.test(o) && (null === r || /number|range|text/.test(r)) && (s = Number(s)), s ? n[o] = s : r === o && "range" !== r && (n[o] = !0)
            }
        ...
        dataRules: function(t) {
            var n, i, r = {},
                o = e(t);
            for (n in e.validator.methods) void 0 !== (i = o.data("rule-" + n.toLowerCase())) && (r[n] = i);
            return r
        },
...
function(e) {
    ...
    var e = function() {
            ...
            e.scrollTop = t + 1;
            var n = e.scrollTop;
            return e.scrollTop = t, n > t ? e : document.body
        }(),
        t = function(t) {
            var n = e.scrollTop;
            if (2 > t.length) t = -n;
        ...
        n = function(n) {
            ...
            if (r) {
                ...
                requestAnimationFrame(function t(n) {
                    o.set("elapsed", n - s), n = o.get("duration");
                    var a = o.get("elapsed"),
                        l = r.get("start"),
                        u = r.get("delta");
                    e.scrollTop = Math.round(u * (1 - Math.pow(2, -10 * a / n)) + l), o.get("elapsed") < o.get("duration") ? requestAnimationFrame(t) : (history.pushState(null, null, i), e.scrollTop = r.get("start") + r.get("delta"))
                })
            }
        },
...
function r(e) {
    return _[e] || String.fromCharCode(e)
}

function o(e, t, n) {
    for (var i in t) !n && i in e || (e[i] = t[i]);
    return e
}
...
function a(e) {
    var n = {};
    for (var i in e) n[i] = t(e[i]) ? s(e[i], e) : e[i];
    return n
}
...
function l(e) {
    ...
    function s(e) {
        for (F = 0; F < X.length; F++) R = X[F], i(R) ? L[(e ? "add" : "remove") + "EventListener"].call(L, R, D, !1) : t(R) ? D = R : L = R
    }

    function l() {
        k(A), A = O(l), G || (n(e.setup), G = t(e.setup), n(e.resize)), e.running && !U && (e.dt = (M = +new Date) - e.now, e.millis += e.dt, e.now = M, n(e.update), e.autoclear && K && e.clear(), n(e.draw)), U = ++U % e.interval
    }

    function u() {
        L = Q ? e.style : e.canvas, P = Q ? "px" : "", e.fullscreen && (e.height = y.innerHeight, e.width = y.innerWidth), L.height = e.height + P, L.width = e.width + P, e.retina && K && $ && (L.height = e.height * $, L.width = e.width * $, L.style.height = e.height + "px", L.style.width = e.width + "px", e.scale($, $)), G && n(e.resize)
    }

    function c(e, t) {
        return I = t.getBoundingClientRect(), e.x = e.pageX - I.left - y.scrollX, e.y = e.pageY - I.top - y.scrollY, e
    }

    function d(t, n) {
        return c(t, e.element), n = n || {}, n.ox = n.x || t.x, n.oy = n.y || t.y, n.x = t.x, n.y = t.y, n.dx = n.x - n.ox, n.dy = n.y - n.oy, n
    }

    function f(e) {
        if (e.preventDefault(), H = a(e), H.originalEvent = e, H.touches)
            for (V.length = H.touches.length, F = 0; F < H.touches.length; F++) V[F] = d(H.touches[F], V[F]);
        else V.length = 0, V[0] = d(H, Y);
        return o(Y, V[0], !0), H
    }

    function p(t) {
        for (t = f(t), B = (z = X.indexOf(j = t.type)) - 1, e.dragging = !!/down|start/.test(j) || !/up|end/.test(j) && e.dragging; B;) i(X[B]) ? n(e[X[B--]], t) : i(X[z]) ? n(e[X[z++]], t) : B = 0
    }

    function g(t) {
        W = t.keyCode, q = "keyup" == t.type, J[W] = J[r(W)] = !q, n(e[t.type], t)
    }

    function w(t) {
        e.autopause && ("blur" == t.type ? T : E)(), n(e[t.type], t)
    }
    ...
    function S() {
        N = e.element.parentNode, F = b.indexOf(e), N && N.removeChild(e.element), ~F && b.splice(F, 1), s(!1), T()
    }
    var A, D, L, N, I, F, P, M, R, H, j, W, q, B, z, U = 0,
        V = [],
        G = !1,
        $ = y.devicePixelRatio,
        Q = e.type == m,
        ...
        X = [e.element, p, "mousedown", "touchstart", p, "mousemove", "touchmove", p, "mouseup", "touchend", p, "click", v, g, "keydown", "keyup", y, w, "focus", "blur", u, "resize"],
        J = {};
    for (W in _) J[_[W]] = !1;
    return o(e, {
        touches: V,
        ...
        start: E,
        stop: T
    }), b.push(e), e.autostart && E(), s(!0), u(), l(), e
}
for (var u, c, d = "E LN10 LN2 LOG2E LOG10E PI SQRT1_2 SQRT2 abs acos asin atan ceil cos exp floor log round sin sqrt tan atan2 pow max min".split(" "), f = "__hasSketch", p = Math, h = "canvas", g = "webgl", m = "dom", v = document, y = window, b = [], w = {
        fullscreen: !0,
        autostart: !0,
        autoclear: !0,
        autopause: !0,
        ...
        install: function(t) {
            if (!t[f]) {
                for (var i = 0; i < d.length; i++) t[d[i]] = p[d[i]];
                o(t, {
                    TWO_PI: 2 * p.PI,
                    HALF_PI: p.PI / 2,
                    QUATER_PI: p.PI / 4,
                    random: function(t, i) {
                        return e(t) ? t[~~(p.random() * t.length)] : (n(i) || (i = t || 1, t = 0), t + p.random() * (i - t))
                    },
                    lerp: function(e, t, n) {
                        return e + n * (t - e)
                    },
        ...
        create: function(e) {
            return e = o(e || {}, w), e.globals && E.install(self), u = e.element = e.element || v.createElement(e.type === m ? "div" : "canvas"), c = e.context = e.context || function() {
                switch (e.type) {
                    case h:
                        return u.getContext("2d", e);
                    case g:
                        return u.getContext("webgl", e) || u.getContext("experimental-webgl", e);
                    case m:
                        return u.canvas = u
                }
            }(), (e.container || v.body).appendChild(u), E.augment(c, e)
        },
        augment: function(e, t) {
            return t = o(t || {}, w), t.element = e.canvas || e, t.element.className += " sketch", o(e, t, !0), l(e)
        }
    }, T = ["ms", "moz", "webkit", "o"], C = self, x = 0, S = "AnimationFrame", A = "request" + S, D = "cancel" + S, O = C[A], k = C[D], L = 0; L < T.length && !O; L++) O = C[T[L] + "Request" + S], k = C[T[L] + "Cancel" + S];
return C[A] = O = O || function(e) {
    var t = +new Date,
        n = p.max(0, 16 - (t - x)),
...
function e(e, n, i) {
    ...
    var r = e.style,
        o = {};
    for (var s in n) i && (o[s] = r[s] || ""), r[s] = n[s];
    return o
}

function t(e) {
    var t;
    e.transition && (t = e.transition, delete e.transition, e[g] = t), e.transform && (t = e.transform, delete e.transform, e[m] = t)
}

function n(t, n) {
    for (var i, r = getComputedStyle(t), o = document.createElement("div"), s = b.length; s--;) i = b[s], o.style[i] = r[i];
    return e(o, {
        visibility: "hidden",
        width: n.width + "px",
        height: n.height + "px",
        display: "inline" === r.display ? "inline-block" : r.display
    }), p.deepCopy ? o.innerHTML = t.innerHTML : o.textContent = t.textContent, o
}
var i, r, o, s, a = "WebkitAppearance" in document.documentElement.style ? "-webkit-" : "",
    l = /^([\d\.]+)%$/,
    ...
    h = function() {
        ...
        return t.some(function(t) {
            if (void 0 !== u.style[t]) return e.transition = t, e.transEnd = i[t], !0
        }), n.some(function(t) {
            if (void 0 !== u.style[t]) return e.transform = t, !0
        }), e
    }(),
    g = h.transition,
    m = h.transform,
...
var b = ["position", "display", "float", "top", "left", "right", "bottom", "marginBottom", "marginLeft", "marginRight", "marginTop", "font", "lineHeight", "verticalAlign"],
    w = {
        ...
        open: function(t, h) {
            if (!d && !f) {
                i = "string" == typeof t ? document.querySelector(t) : t, p.onBeforeOpen && p.onBeforeOpen(i), d = !0, f = !0, r = i.parentNode;
                var g = i.getBoundingClientRect(),
                    m = Math.min(p.maxWidth / g.width, p.maxHeight / g.height),
                    b = g.left - (window.innerWidth - g.width) / 2,
                    w = g.top - (window.innerHeight - g.height) / 2;
                o = n(i, g), s = e(i, {
                    position: "absolute",
                    top: 0,
                    left: 0,
                ...
                var _ = i.style.width.match(l),
                    E = i.style.height.match(l);
                if (_ || E) {
                    var T = _ ? +_[1] / 100 : 1,
                        C = E ? +E[1] / 100 : 1;
                    e(c, {
                        width: ~~(g.width / T) + "px",
                        height: ~~(g.height / C) + "px"
                    })
                }
                r.appendChild(u), r.appendChild(c), r.insertBefore(o, i), c.appendChild(i), u.style.display = "block";
                i.offsetHeight;
                return u.style.opacity = p.bgOpacity, e(i, {
                    transition: v + " " + p.transitionDuration + " " + p.transitionTimingFunction,
                    transform: "scale(" + m + ")"
                }), i.addEventListener(y, function e() {
                    i.removeEventListener(y, e), f = !1, (h = h || p.onOpen) && h(i)
                }), this
            }
        },
        close: function(t) {
            if (d && !f) {
                f = !0, p.onBeforeClose && p.onBeforeClose(i);
                var n = o.getBoundingClientRect(),
                    a = n.left - (window.innerWidth - n.width) / 2,
                    l = n.top - (window.innerHeight - n.height) / 2;
                return u.style.opacity = 0, e(i, {
                    transform: "translate(" + a + "px, " + l + "px)"
                }), i.addEventListener(y, function n() {
                    i.removeEventListener(y, n), e(i, s), r.insertBefore(i, o), r.removeChild(o), r.removeChild(u), r.removeChild(c), u.style.display = "none", o = null, d = !1, f = !1, (t = "function" == typeof t ? t : p.onClose) && t(i)
                }), this
            }
        },
        listen: function t(n) {
            if ("string" != typeof n) return e(n, {
                ...
                e.stopPropagation(), d ? w.close() : w.open(n)
            }), this;
            for (var i = document.querySelectorAll(n), r = i.length; r--;) t(i[r])
        }
    };
u.addEventListener("click", w.close), c.addEventListener("click", w.close), "object" == typeof exports ? module.exports = w : "function" == typeof define && define.amd ? define(function() {
    return w
}) : this.Zoomerang = w
}(), $(function() {
slideshow.initialize(), services.initialize(), contactForm.initialize(), animation.initialize(), dropdownSubmenu.initialize(), zoomerang.initialize(), window.devicePixelRatio >= 1.2 && $("[data-2x]").each(function() {
...
animation = {
    ...
    update: function() {
        for (var e = _this.elements.length - 1; e >= 0; e--) {
    ...
    triggerAnimate: function(e) {
        var t = e.data("animate"),
            ...
            r = e.data("animate-duration") || null;
        null !== n && e.addClass("infinite"), null !== i && e.css({
    ...
    initialize: function() {
        ...
        e.length && e.validate({
            ...
            highlight: function(e) {
                $(e).closest(".form-group").removeClass("success").addClass("error")
            },
            success: function(e) {
                e.addClass("valid").closest(".form-group").removeClass("error").addClass("success")
            }
        })
    }
},
services = {
    screenHover: function() {
        $screens = $(".features-hover-section .images img"), $features = $(".features-hover-section .features .feature"), $features.mouseenter(function() {
            if (!$(this).hasClass("active")) {
                $features.removeClass("active"), $(this).addClass("active");
                var e = $features.index(this);
                $screens.stop().fadeOut(), $screens.eq(e).fadeIn()
            }
        })
    },
    initialize: function() {
...
slideshow = {
    initialize: function() {
        function e(e) {
            n.removeClass("active"), n.eq(e).addClass("active")
        }
        var t = $(".slideshow"),
            n = t.find(".slide"),
            i = t.find(".btn-nav.prev"),
            r = t.find(".btn-nav.next"),
            o = 0,
            s = setInterval(function() {
                o++, o >= n.length && (o = 0), e(o)
            }, 4500);
        i.click(function() {
            clearInterval(s), s = null, o--, o < 0 && (o = n.length - 1), e(o)
        }), r.click(function() {
            clearInterval(s), s = null, o++, o >= n.length && (o = 0), e(o)
        }), t.hover(function() {
            i.addClass("active"), r.addClass("active")
        }, function() {
            i.removeClass("active"), r.removeClass("active")
        })
    }
};
